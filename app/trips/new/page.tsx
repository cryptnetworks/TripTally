  ...
  return (
    <PageShell>
      ...
      <section className="card mx-auto max-w-2xl p-5">
        <form className="grid gap-4" action={createTrip}>
          <div>
            <label className="label" htmlFor="name">Trip name</label>
            <input className="field" id="name" name="name" maxLength={140} required />
          </div>
          <div>
            <label className="label" htmlFor="destination">Destination</label>
            <input className="field" id="destination" name="destination" maxLength={140} />
          </div>
          ...
          <button className="btn-primary" type="submit">Save trip</button>
        </form>
      </section>
    </PageShell>
  );
